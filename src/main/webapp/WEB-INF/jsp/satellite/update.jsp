			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="update_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/saveupdate" class="row g-3" novalidate="novalidate">
								...
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${update_satellite_attr.dataDiLancio}' />
								<div class="col-md-3">
									<label for="dataDiLancio" class="form-label">Data di Lancio </label>
                        			<spring:bind path="dataDiLancio">
	                        		<input class="form-control ${status.error ? 'is-invalid' : ''}" id="dataDiLancio" type="date" placeholder="dd/MM/yy"
	                            		title="formato : gg/mm/aaaa"  name="dataDiLancio"  
	                            		value="${parsedDate}" >
		                            </spring:bind>
	                            	<form:errors  path="dataDiLancio" cssClass="error_field" />
								</div>

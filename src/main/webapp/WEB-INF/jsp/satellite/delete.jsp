			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
						...
						<form:form modelAttribute="delete_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/savedelete/${delete_satellite_attr.id}" class="row g-3" novalidate="novalidate">
